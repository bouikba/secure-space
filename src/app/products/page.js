...
function SearchBar({ searchValue, setSearchValue }) {
  return (
    <div className="max-width p-4">
      <div className="flex">
        <div className="flex w-10 items-center justify-center rounded-tl-lg rounded-bl-lg border-r border-sh-dark bg-light p-5">
          <svg viewBox="0 0 20 20" aria-hidden="true" className="pointer-events-none absolute w-5 fill-dark transition">
        ...
        <input
          ...
          className="w-full max-w-[300px] bg-light pl-2 text-base font-semibold outline-0"
